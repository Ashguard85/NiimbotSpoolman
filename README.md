# Spoolman NIIMBOT Labels – Docker v8
...
Docker v8 ↔ Pages v8. Das Frontend ist bis auf `config.js` identisch: Docker startet standardmäßig im Server-Modus, Pages im lokalen Modus.
...
- QR-/NIIMBOT-Browserbibliotheken werden in v8 von UNPKG geladen und anschließend vom Service Worker gecacht.
